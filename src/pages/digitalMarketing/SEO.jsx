...
import { FaSearch, FaChartLine, FaLink, FaPenNib } from "react-icons/fa";
...
function SEO() {
  ...
  const faqs = [
    {
      q: "What is SEO?",
      a: "SEO (Search Engine Optimization) improves your website’s visibility on search engines like Google to drive organic traffic.",
    },
    {
      q: "How long does SEO take to show results?",
      a: "SEO typically takes 3–6 months for noticeable improvements depending on competition and strategy.",
    },
    {
      q: "Do you provide technical SEO?",
      a: "Yes. We optimize site speed, mobile responsiveness, structure, indexing, and more.",
    },
  ];
    ...
    <div>
      ...
      >
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Improve your search rankings, drive organic traffic, and grow your
          ...
          {[
            {
              ...
              desc: "Identify high-impact keywords that drive relevant traffic.",
            },
            {
              icon: <FaPenNib className="text-emerald-600 text-3xl mb-4" />,
              title: "On-Page SEO",
              desc: "Optimize content, structure, and meta tags for rankings.",
            },
            {
              icon: <FaLink className="text-emerald-600 text-3xl mb-4" />,
              title: "Link Building",
              desc: "Build high-quality backlinks to improve authority.",
            },
            {
              icon: <FaChartLine className="text-emerald-600 text-3xl mb-4" />,
              title: "Technical SEO",
              desc: "Enhance speed, indexing, and overall site performance.",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
          ...
          {[
            ...
            >
              ...
              <p className="text-sm text-gray-600">
                Structured workflow to maximize search visibility and growth.
              </p>
            </motion.div>
          ))}
        </div>
